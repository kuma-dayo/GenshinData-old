...
-- 怪物
monsters = {
	{ config_id = 3001, monster_id = 20010801, pos = { x = 7.130, y = 0.120, z = -6.251 }, rot = { x = 0.000, y = 346.531, z = 0.000 }, level = 1 },
	{ config_id = 3002, monster_id = 20010801, pos = { x = -6.145, y = 0.120, z = -6.264 }, rot = { x = 0.000, y = 21.465, z = 0.000 }, level = 1 },
	...
	{ config_id = 3006, monster_id = 21010501, pos = { x = -24.865, y = 0.120, z = -0.511 }, rot = { x = 0.000, y = 65.482, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3007, monster_id = 21010501, pos = { x = -23.789, y = 0.120, z = 18.264 }, rot = { x = 0.000, y = 119.966, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3008, monster_id = 21010501, pos = { x = -24.483, y = 0.120, z = 4.381 }, rot = { x = 0.000, y = 99.554, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3009, monster_id = 21011001, pos = { x = -24.385, y = 0.120, z = 10.658 }, rot = { x = 0.000, y = 112.349, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3010, monster_id = 21011001, pos = { x = -24.760, y = 0.120, z = -13.973 }, rot = { x = 0.000, y = 55.499, z = 0.000 }, level = 1, pose_id = 32 },
	{ config_id = 3011, monster_id = 20010801, pos = { x = 12.917, y = 0.120, z = 0.360 }, rot = { x = 0.000, y = 315.283, z = 0.000 }, level = 1, pose_id = 0 },
	{ config_id = 3012, monster_id = 20010801, pos = { x = 12.406, y = 0.120, z = -9.369 }, rot = { x = 0.000, y = 322.134, z = 0.000 }, level = 1, pose_id = 0 },
	{ config_id = 3013, monster_id = 21010301, pos = { x = 0.373, y = 0.120, z = -11.272 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, pose_id = 402 },
	{ config_id = 3014, monster_id = 21010301, pos = { x = -12.092, y = 0.120, z = -6.434 }, rot = { x = 0.000, y = 50.167, z = 0.000 }, level = 1, pose_id = 402 },
	{ config_id = 3015, monster_id = 21010301, pos = { x = -13.641, y = 0.120, z = 1.147 }, rot = { x = 0.000, y = 76.240, z = 0.000 }, level = 1, pose_id = 402 },
	{ config_id = 3016, monster_id = 21020101, pos = { x = 1.000, y = 0.120, z = -7.530 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3017, monster_id = 21020201, pos = { x = -10.648, y = 0.120, z = 0.463 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3018, monster_id = 20010801, pos = { x = 0.922, y = 0.120, z = -6.288 }, rot = { x = 0.000, y = 0.971, z = 0.000 }, level = 1 },
	{ config_id = 3019, monster_id = 21010301, pos = { x = -8.258, y = 0.120, z = 8.222 }, rot = { x = 0.000, y = 128.249, z = 0.000 }, level = 1, pose_id = 402 },
	{ config_id = 3020, monster_id = 21010601, pos = { x = 2.489, y = 0.034, z = 7.855 }, rot = { x = 0.000, y = 220.666, z = 0.000 }, level = 1 },
	{ config_id = 3028, monster_id = 21010701, pos = { x = 6.260, y = 0.034, z = 4.822 }, rot = { x = 0.000, y = 246.123, z = 0.000 }, level = 1 },
	{ config_id = 3029, monster_id = 21010601, pos = { x = 8.696, y = 0.034, z = 0.173 }, rot = { x = 0.000, y = 292.240, z = 0.000 }, level = 1 },
	{ config_id = 3030, monster_id = 21010701, pos = { x = 5.624, y = 0.034, z = -6.022 }, rot = { x = 0.000, y = 325.983, z = 0.000 }, level = 1 },
	{ config_id = 3031, monster_id = 21010601, pos = { x = 2.339, y = 0.034, z = -10.355 }, rot = { x = 0.000, y = 353.521, z = 0.000 }, level = 1 }
}
...
suites = {
	...
	},
	{
		-- suite_id = 2,
		-- description = suite_2,
		monsters = { 3001, 3002, 3003, 3004, 3005, 3018 },
		gadgets = { 3021 },
		regions = { },
	...
	},
	{
		-- suite_id = 4,
		-- description = suite_4,
		monsters = { 3011, 3012, 3013, 3014, 3015, 3019 },
		gadgets = { 3021 },
		regions = { },
	...
	},
	{
		-- suite_id = 6,
		-- description = suite_6,
		monsters = { 3020, 3028, 3029, 3030, 3031 },
		gadgets = { 3021 },
		regions = { },
		triggers = { "CHALLENGE_SUCCESS_3026", "CHALLENGE_FAIL_3027", "ANY_MONSTER_DIE_3032" },
		rand_weight = 100
	}
}
...
function action_EVENT_ANY_MONSTER_LIVE_3022(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 191, 300, 240509003, 24, 0) then
		return -1
	end
...
function condition_EVENT_ANY_MONSTER_DIE_3023(context, evt)
	...
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240509003) ~= 0 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_3023(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240509003, 3)
...
function action_EVENT_ANY_MONSTER_DIE_3024(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240509003, 4)
...
function action_EVENT_ANY_MONSTER_DIE_3025(context, evt)
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240509003, 6)
...
function action_EVENT_CHALLENGE_SUCCESS_3026(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240509001, suite = 1 }) then
			return -1
		end
...
function action_EVENT_CHALLENGE_FAIL_3027(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240509001, 1002, GadgetState.GearStart) then
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240509003, suite = 1 }) then
			return -1
		end
...
function action_EVENT_ANY_MONSTER_DIE_3032(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240509003, 5)
