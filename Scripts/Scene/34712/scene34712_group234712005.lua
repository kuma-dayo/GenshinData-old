...
monsters = {
	...
	{ config_id = 5006, monster_id = 20050601, pos = { x = 3.018, y = -0.102, z = 11.005 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	{ config_id = 5007, monster_id = 20050601, pos = { x = -3.080, y = -0.102, z = 11.006 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
